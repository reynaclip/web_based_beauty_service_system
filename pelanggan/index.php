                ...
                <div class="orders-grid">
                    ...
                    <div class="order-card">
                        <div class="order-header">
                            <div>
                                <div class="order-code"><?php echo htmlspecialchars($order['kode_pesanan'] ?? 'ORD-' . $order['id']); ?></div>
                        ...
                        <div class="order-actions">
                            ...
                            <?php else: ?>
                                <span class="btn-action btn-cancel" style="opacity: 0.6; cursor: not-allowed;">
                                    <i class="fas fa-times"></i> Batalkan
                                </span>
                            <?php endif; ?>
                            
                            <?php if ($order['status'] === 'selesai'): ?>
                                <a href="print.php?id=<?php echo $order['id']; ?>" class="btn-action btn-print" target="_blank">
