                ...
                <div class="stat-card">
                    ...
                    <div class="stat-info">
                        ...
                        <div class="stat-number">
                            <a href="tambah.php" class="btn-primary" style="font-size: 0.9rem; padding: 8px 15px;">
                        ...
                        <tr>
                            ...
                            <td>
                                <div class="action-buttons">
                                    ...
                                    <a href="toggle_status.php?id=<?php echo $item['id']; ?>&status=nonaktif" 
                                    ...
                                    <?php else: ?>
                                    <a href="toggle_status.php?id=<?php echo $item['id']; ?>&status=aktif" 
